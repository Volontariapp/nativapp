        ...
        <View style={styles.section}>
          ...
          <AppText>
            ...
            <AppText
              style={styles.link}
              onPress={() => {
                void Linking.openURL('https://oblador.github.io/react-native-vector-icons/');
              }}
            >
              ici
            </AppText>
            {'\n'} Pour Ajouter une icone, renseignez son nom dans le composant AppIcons.tsx avec le
            props "icon" et la librairie dont il provient dans le props iconLibrary.
          </AppText>
